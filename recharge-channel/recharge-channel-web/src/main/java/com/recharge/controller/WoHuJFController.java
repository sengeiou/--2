...
/**
 * @author user
 * @create 2020/12/4 17:58
 */
@Controller
@RequestMapping("/wohuJF")
public class WoHuJFController {
    @Autowired
    ...
    public String callBack(@RequestBody WoHu woHu) {
        ...
        logger.info("wohuJF callback :{}", JSON.toJSONString(responseOrder));
        logger.info("wohuJF remark1 :{}", responseOrder.getOutChannelOrderId());
        channelService.callBack("100111", responseOrder);
        return "success";
    }
}
