...
@Controller
@RequestMapping("/fenghuang")
public class FengHuangSkController {

    @Autowired
    private ChannelService channelService;

    private String channelId = "100037";
    ...
    public String callBack(String userid,String orderid,String sporderid,String merchantsubmittime,String resultno,String sign,String payno){
        ...
        logger.info("fenghuang  payno :{}", responseOrder.getOutChannelOrderId());
