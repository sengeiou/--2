...
/**
 * @author user
 * @create 2020/11/3 21:36
 */
@Controller
@RequestMapping("/yuanfeiCG")
public class YuanFeiCGController {
    @Autowired
    ...
    public String callBack(String userid,String orderid,String sporderid,String merchantsubmittime,String resultno,String sign,String parvalue,String remark1,String payno,String fundbalance) {
        ...
        logger.info("yuanfeiCG callback :{}", JSON.toJSONString(responseOrder));
        logger.info("yuanfeiCG remark1 :{}", responseOrder.getOutChannelOrderId());
        channelService.callBack("100100", responseOrder);
        return "success";
    }
}
