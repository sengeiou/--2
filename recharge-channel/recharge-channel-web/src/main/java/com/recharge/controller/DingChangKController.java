 ...
 * @create 2021/2/23 17:24
 */
@Controller
@RequestMapping("/dingChangK")
public class DingChangKController {
    @Autowired
    ...
    public String callBack(String agent, String out_order_no, String order_no, String amount, String agent_price, String status, String refid, String sign) {
        ...
        logger.info("dingChangK callback :{}", JSON.toJSONString(responseOrder));
        channelService.callBack("100138", responseOrder);
        return "SUCCESS";
    }
}
