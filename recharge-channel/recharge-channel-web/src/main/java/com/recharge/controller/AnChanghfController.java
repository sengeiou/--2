...
@Controller
@RequestMapping("/anChanghf")
public class AnChanghfController {
    ...
    public String callBack(String userid, String orderid, String sporderid, String merchantsubmittime, String resultno,
        ...
        logger.info("anchangHf remark1 :{}", responseOrder.getOutChannelOrderId());
        channelService.callBack("100054", responseOrder);
        return "success";
    }
}
