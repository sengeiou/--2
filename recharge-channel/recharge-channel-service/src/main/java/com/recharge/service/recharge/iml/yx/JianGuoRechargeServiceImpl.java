 ...
 */
@Service
public class JianGuoRechargeServiceImpl extends AbsChannelRechargeService {
    ...
    public static void main(String[] args) {
        ...
        channelOrder.setChannelOrderId("PS201703221321002");
        ...
        JianGuoRechargeServiceImpl jianGuoRechargeService = new JianGuoRechargeServiceImpl();
...
//        productid_saleprice
        ProductRelation productRelation  = queryChannelProductId(rechargeOrderBean.getProductName(),"100006");

//        ProductRelation productRelation = new ProductRelation();
//        productRelation.setChannelProductId("409_10");
