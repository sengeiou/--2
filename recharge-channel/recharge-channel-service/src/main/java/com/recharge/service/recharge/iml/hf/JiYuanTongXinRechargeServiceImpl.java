...
@Service
public class JiYuanTongXinRechargeServiceImpl extends AbsChannelRechargeService {
    ...
    public ProcessResult recharge(Channel channel, ChannelOrder channelOrder, RechargeOrderBean rechargeOrderBean) {
        ...
        requestMap.put("spordertime",new SimpleDateFormat("yyyyMMddHHmmss").format(new Date()));
        requestMap.put("sporderid", channelOrder.getChannelOrderId());

        String md5Source = "userid="+requestMap.get("userid")+"&productid="
                +"&price="+requestMap.get("price")+"&num=1&mobile="+requestMap.get("mobile")+"&spordertime="+requestMap.get("spordertime")
