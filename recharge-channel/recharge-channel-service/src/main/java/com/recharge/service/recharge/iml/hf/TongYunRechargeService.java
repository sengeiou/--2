...
@Service
public class TongYunRechargeService extends AbsChannelRechargeService {
...
//        requestMap.put("ProductId",null);
        ...
        if (huaFeiRechargeInfoBean.getPhoneBelong()!=null){

            requestMap.put("Type", huaFeiRechargeInfoBean.getPhoneBelong().toString());
        }
