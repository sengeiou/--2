 ...
 */
@Service
public class JiuYaRechargeService extends AbsChannelRechargeService {
    ...
    public ProcessResult recharge(Channel channel, ChannelOrder channelOrder, RechargeOrderBean rechargeOrderBean) {
        ...
        productRelation = queryChannelProductId(huaFeiRechargeInfoBean.getOperator() + "网厅" + huaFeiRechargeInfoBean.getAmt() + "元", "100066");
        ...
        try {
            logger.info("JiuYa send recharge request params:{}", JSONObject.toJSONString(requestMap));
            String responseBody = HttpClientUtils.invokePostHttp(configJSONObject.getString("url"), requestMap, "utf-8", 5000);
            logger.info("JiuYa send recharge response :{}", JSONObject.toJSONString(responseBody));
