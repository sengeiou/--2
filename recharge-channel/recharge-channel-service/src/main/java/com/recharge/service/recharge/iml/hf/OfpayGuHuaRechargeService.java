 ...
 */
@Service
public class OfpayGuHuaRechargeService extends AbsChannelRechargeService {
    ...
    public ProcessResult recharge(Channel channel, ChannelOrder channelOrder, RechargeOrderBean rechargeOrderBean) {
        ...
        GuHuaRechargeInfoBean huaFeiRechargeInfoBean = (GuHuaRechargeInfoBean) rechargeOrderBean.getRechargeInfoObj(GuHuaRechargeInfoBean.class);
...
//        requestMap.put("cardid", "140101");
        ...
        requestMap.put("teltype", huaFeiRechargeInfoBean.getGuHuaType().toString());
        requestMap.put("chargeType", huaFeiRechargeInfoBean.getGuHuaChargeType().toString());
