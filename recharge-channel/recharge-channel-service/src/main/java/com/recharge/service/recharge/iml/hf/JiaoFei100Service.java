...
@Service
public class JiaoFei100Service extends AbsChannelRechargeService {
    ...
    public ProcessResult recharge(Channel channel, ChannelOrder channelOrder, RechargeOrderBean rechargeOrderBean) {
        ...
        String souceString ="APIID="+apiId+"&Account="+huaFeiRechargeInfoBean.getPhone()+"&BuyNum=1&CreateTime="
                +requestTime+"&isCallBack=1&OrderID="+channelOrder.getChannelOrderId()+"&TotalPrice="+huaFeiRechargeInfoBean.getAmt().multiply(new BigDecimal("1000"))
                +"&TradeType=10&UnitPrice="+huaFeiRechargeInfoBean.getAmt().multiply(new BigDecimal("1000"))+"&APIKEY="+apiKey;
//        tradetype 10 话费直充
        StringBuffer requestUrl = new StringBuffer(url).append("?APIID=").append(apiId).append("&TradeType=10").append("&Account=")
                .append(huaFeiRechargeInfoBean.getPhone()).append("&UnitPrice=").append(huaFeiRechargeInfoBean.getAmt().multiply(new BigDecimal("1000")))
                .append("&BuyNum=").append("1").append("&TotalPrice=").append(huaFeiRechargeInfoBean.getAmt().multiply(new BigDecimal("1000")))
...
//        tradetype 10 话费直充
        ...
        try {
            ...
            if (StringUtils.equals("10027",retCode)){
                channelOrder.setOutChannelOrderId(JSONObject.parseObject(responseBody).getString("OutOrderNo"));
...
//        tradetype 10 话费直充
    ...
    @Test
    public void test(){
        JiaoFei100Service jiaoFei100Service = new JiaoFei100Service();
        Channel channel = new Channel();
        ChannelOrder channelOrder = new ChannelOrder();
//        channelOrder.setChannelOrderId("cs202012281446");
        channelOrder.setChannelOrderId("cs202012281607");
        channel.setConfigInfo("{apiId:\"18032839533680\",queryUrl:\"http://open.jiaofei100.com/Api/GetOrderInfo.aspx\",apiKey:\"0DDB7A79ABD3C951BEC68F008783C443\",url:\"http://open.jiaofei100.com/Api/PayMobile.aspx\",balanceQueryUrl:\"http://open.jiaofei100.com/Api/GetUserMoney.aspx\"}");
        BigDecimal bigDecimal = jiaoFei100Service.balanceQuery(channel);
//        ProcessResult recharge = jiaoFei100Service.recharge(channel, channelOrder, new RechargeOrderBean());
//        ProcessResult query = jiaoFei100Service.query(channel, channelOrder);
