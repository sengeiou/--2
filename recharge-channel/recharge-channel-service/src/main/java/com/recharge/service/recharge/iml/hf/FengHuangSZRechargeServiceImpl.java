...
@Service
public class FengHuangSZRechargeServiceImpl extends AbsChannelRechargeService {
    ...
    public ProcessResult recharge(Channel channel, ChannelOrder channelOrder, RechargeOrderBean rechargeOrderBean) {
        ...
        try {
            ...
            } else if (StringUtils.equals("9999", retCode.getStringValue())) {
                return new ProcessResult(ProcessResult.UNKOWN, "需找供货商核实");
            }else {
    ...
    public ProcessResult query(Channel channel, ChannelOrder channelOrder) {
        ...
        try {
            ...
            } else if (StringUtils.equals("9999", retCode)) {
                return new ProcessResult(ProcessResult.UNKOWN, "需找供货商核实");
