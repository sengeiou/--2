 ...
 */
@Service
public class NewAnChangSZRechargeService extends AbsChannelRechargeService {
    ...
    public ProcessResult recharge(Channel channel, ChannelOrder channelOrder, RechargeOrderBean rechargeOrderBean) {
        ...
        if (StringUtils.equals(huaFeiRechargeInfoBean.getOperator(), "联通")) {
            productRelation = queryChannelProductId( "联通全国直充", "100060");
            ...
            productRelation = queryChannelProductId("移动全国直充", "100060");
            productId=productRelation.getChannelProductId()+huaFeiRechargeInfoBean.getAmt();
            if (productRelation == null) {
                return new ProcessResult(ProcessResult.FAIL, "提交失败");
            }
        } else {
            productRelation = queryChannelProductId("电信全国直充", "100060");
            productId=productRelation.getChannelProductId()+huaFeiRechargeInfoBean.getAmt();
            if (productRelation == null) {
                return new ProcessResult(ProcessResult.FAIL, "提交失败");
            }
