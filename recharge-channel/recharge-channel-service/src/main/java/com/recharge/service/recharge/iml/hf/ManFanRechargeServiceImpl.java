...
@Service
public class ManFanRechargeServiceImpl extends AbsChannelRechargeService {

    private Logger logger = LoggerFactory.getLogger(getClass());

    public static void main(String[] args) {
        ManFanRechargeServiceImpl jiaoFei100Service = new ManFanRechargeServiceImpl();
        ...
        rechargeOrderBean.setOrderId("R0077008898");
        HuaFeiRechargeInfoBean huaFeiRechargeInfoBean = new HuaFeiRechargeInfoBean();
        huaFeiRechargeInfoBean.setAmt(new BigDecimal(10));
        huaFeiRechargeInfoBean.setPhone("13151715613");
        huaFeiRechargeInfoBean.setOperator("联通");
    ...
    public ProcessResult recharge(Channel channel, ChannelOrder channelOrder, RechargeOrderBean rechargeOrderBean) {
        ...
        try {
            ...
            if (StringUtils.equals(huaFeiRechargeInfoBean.getOperator(),"联通")){
                productRelation = queryChannelProductId("全国"+huaFeiRechargeInfoBean.getOperator()+"无票资源"+huaFeiRechargeInfoBean.getAmt()+"元" , "100044");
                if(productRelation == null){
                    return new ProcessResult(ProcessResult.FAIL,"提交失败");
                }
            }else {
                productRelation = queryChannelProductId("全国"+huaFeiRechargeInfoBean.getOperator()+huaFeiRechargeInfoBean.getAmt() , "100044");
                if(productRelation == null){
                    return new ProcessResult(ProcessResult.FAIL,"提交失败");
                }
            }
